...
const ProductDetail = ({ product }) => {
  ...
  return (
    <>
        ...
        <Typography style={{ marginTop: 5, color: "#878787, fontSize" }}>
            8 Ratings & 1 Reviews
        ...
        <SmallText>
            ...
            <Typography><StyledBadge/>Bank Offer 10% Off on Bank of Baroda Mastercard debit card first time transaction, T&C</Typography>
